...
maxWidth = grid::unit.pmax(pA$widths[2:3], pB$widths[2:3], pC$widths[2:3], pD$widths[2:3], pE$widths[2:3], pF$widths[2:3], pG$widths[2:3], pH$widths[2:3])
...
grid.arrange(pA, pB, pC, pD, pE, pF, pG, pH, ncol = 2, bottom = 'Abundance')
@
\clearpage
...
pE <- ggplot_gtable(ggplot_build(p5))
pF <- ggplot_gtable(ggplot_build(p6))
maxWidth = grid::unit.pmax(pA$widths[2:3], pB$widths[2:3], pC$widths[2:3], pD$widths[2:3], pE$widths[2:3], pF$widths[2:3])
...
grid.arrange(pA, pB, pC, pD, pE, pF, ncol = 2, bottom = 'Abundance')
@
\clearpage
