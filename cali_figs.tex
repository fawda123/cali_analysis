...
{\centering \includegraphics[width=0.8\textwidth]{figs/abuplo} 

}

\caption[Relative abunances of top ten phyla based on wastewater-treatment plant (municipality) and distance from the outfall pipe as determined by percent abundance]{Relative abunances of top ten phyla based on wastewater-treatment plant (municipality) and distance from the outfall pipe as determined by percent abundance. LACI is City of Los Angeles; SDCI is City of San Diego, LACO is Los Angeles County and ORCO is Orange County, California.}\label{fig:abuplo}
\end{figure}
...
% Date and time: Thu, Jul 18, 2019 - 9:19:19 AM
...
% Table created by stargazer v.5.2.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Thu, Jul 18, 2019 - 9:19:20 AM
\begin{table}[!htbp] \centering 
